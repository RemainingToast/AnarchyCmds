...
public class PlayerDataUtilities {
    public static final String playerDataFolder = "plugins/AnarchyCore/players/";
    ...
    public static PlayerData loadPlayerDataNoCreate(UUID player) {
        ...
        try {
            return ((PlayerData) AnarchyCore.gson.fromJson(new FileReader(playerDataFile), new TypeToken<PlayerData>() {
